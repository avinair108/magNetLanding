...
function Newsletter() {
  const handleSignUp = () => {
    window.location.href = 'https://forms.office.com/Pages/ResponsePage.aspx?id=TlBonWP7AE2TNqNnpWy1LTByA66Z_EJOr7B1cYWQoZpUNVJUWEZVQkVKTFBQVjVOVUxLRkxaQ1JLNC4u';
  };
